...
However, discovering novel interactions between drugs and target proteins is crucial for the development of new drugs, since the aberrant expression of proteins may cause side effects of drugs. 
...
In this project, our goal is to focus on deep learning approaches for drug-target interaction (DTI) prediction. 
